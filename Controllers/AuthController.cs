...
namespace ProductApi.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(IConfiguration config, EComDbContext context, IHttpClientFactory httpClientFactory)
        {
            _config = config;
            _context = context;
        ...
        public IActionResult Login()
        {
            ...
            var redirectUri = Uri.EscapeDataString("https://adilecombackendapp-hub0erhqgabhbvgr.northcentralus-01.azurewebsites.net/auth/callback");
        ...
        public async Task<IActionResult> Callback([FromQuery] string code, [FromQuery] string state)
        {
            ...
            if (userProfile == null)
            {
                ...
                string role = githubUser.login.Equals("adilraman-cognizant", StringComparison.OrdinalIgnoreCase)
                    ? "administrator"
                    : "customer";
            ...
            var claims = new List<Claim>
    {
        ...
        new Claim(ClaimTypes.Role, userProfile.Role)
            ...
            var redirectUrl = $"https://adilecomfrontendapp-a2cxhpc7erbxapht.northcentralus-01.azurewebsites.net/tokenreceiver?token={jwtToken}&newUser={isNewUser}";
